...
date: '`r format(Sys.Date(), "%B %d, %Y")`'#"January 27, 2017"
output:
...
**_MILESTONE 2_:Working Prototype** The next milestone is due on March 15^th^, and I will spend from March 1^st^-15^th^ working on this manuscript. 
...
**_MILESTONE 3_:Final Manuscript** Due Wednesday, April 19^the^.

---
title: "Milestone 1: CDC's National Survey of Family Growth"
...
[comment]: <> (As a ballpark, your proposal should be about 2-3 pages of text, along with shells of the tables and figures that you plan. You could even include some preliminary data acquisition / analysis steps.)

##Overview and Motivation: 
[comment]: <> (Why did you undertake this particular project? What inspired you, what are your background and research interests that may have influenced your decision?)
...
##Project Objectives: 
[comment]: <> (What is the primary focal question that you are trying to answer? What would you like to learn and accomplish?)
...
##Data: 
[comment]: <> (from where and how are you acquiring your data? Provide a link to your data source.)
...
[ftp://ftp.cdc.gov/pub/Health_Statistics/NCHS/Datasets/NSFG/2013_2015_FemRespData.dat](ftp://ftp.cdc.gov/pub/Health_Statistics/NCHS/Datasets/NSFG/2013_2015_FemRespData.dat)  

The CDC's SAS setup file for this dataset is available here:  
[ftp://ftp.cdc.gov/pub/Health_Statistics/NCHS/Datasets/NSFG/sas/2013_2015_FemRespSetup.sas](ftp://ftp.cdc.gov/pub/Health_Statistics/NCHS/Datasets/NSFG/sas/2013_2015_FemRespSetup.sas)  

CDC guidance for the use of this data (ie, variable names, past surveys, etc.) is available here:  
[https://www.cdc.gov/nchs/nsfg/nsfg_2013_2015_puf.htm](https://www.cdc.gov/nchs/nsfg/nsfg_2013_2015_puf.htm)  

##Data Wrangling:
[comment]: <> (Do you anticipate that there will be extensive data cleaning / reshaping / extraction? Are there questions you will need to calculate in your data (e.g., perhaps you have height and weight, but not BMI)? How will you implement this particular data wrangling step?)
...
```
```{r, echo=FALSE}
length(NSFG2013$CONSTAT1)
length(NSFG2011$CONSTAT1)
length(NSFG2006$CASEID)
length(NSFG1995$CASEID)
```

Year of NFGS | Number of Respondents | Notes
------------- | -------------|--------------
2013-2015 | `r length(NSFG2013$CONSTAT1)`  | This was the first file imported as a CSV.
2011-2013 | `r length(NSFG2011$CONSTAT1)`       | Imported as CSV.
2006-2010 |  `r length(NSFG2006$CASEID)`      | Imported as CSV.
2002 |       | Cycle 6, 3 SAS setup files that will take more time to work through.
1995 |  `r length(NSFG1995$CASEID)`     | Cycle 5, Imported as CSV.
1988 |       | Cycle 4
1982 |       | Cycle 3
1976 |       | Cycle 2
1973 |       | Cycle 1
...
[comment]: <> (Which methods / visualizations are you planning to use to explore your tidy dataset?)
...
**_MILESTONE 2: Working Prototype_** The next milestone is due on March 15^th^, and I will spend from March 1^st^-15^th^ working on this manuscript. 
